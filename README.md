...
```bash
pnpm add @womorg/blanditiis-fugiat-reprehenderit
```

Using yarn:

```bash
yarn add @womorg/blanditiis-fugiat-reprehenderit
```

Using npm:

```bash
npm install @womorg/blanditiis-fugiat-reprehenderit
```
...
```ts
import { createEvent, Event } from '@womorg/blanditiis-fugiat-reprehenderit';
...
```ts
import { Predicate } from '@womorg/blanditiis-fugiat-reprehenderit';
...
```ts
import { merge } from '@womorg/blanditiis-fugiat-reprehenderit';
...
```ts
import { createInterval } from '@womorg/blanditiis-fugiat-reprehenderit';
...
[npm-url]: https://www.npmjs.com/package/@womorg/blanditiis-fugiat-reprehenderit
[downloads-image]: https://img.shields.io/npm/dw/@womorg/blanditiis-fugiat-reprehenderit.svg?maxAge=43200
[npm-image]: https://img.shields.io/npm/v/@womorg/blanditiis-fugiat-reprehenderit.svg?maxAge=43200
[github-url]: https://github.com/womorg/blanditiis-fugiat-reprehenderit/actions
[github-image]: https://github.com/womorg/blanditiis-fugiat-reprehenderit/workflows/Build%20Package/badge.svg?branch=master
[codecov-url]: https://codecov.io/gh/3axap4eHko/@womorg/blanditiis-fugiat-reprehenderit
[codecov-image]: https://codecov.io/gh/3axap4eHko/@womorg/blanditiis-fugiat-reprehenderit/branch/master/graph/badge.svg?maxAge=43200
[snyk-url]: https://snyk.io/test/npm/@womorg/blanditiis-fugiat-reprehenderit/latest
[snyk-image]: https://snyk.io/test/github/3axap4eHko/@womorg/blanditiis-fugiat-reprehenderit/badge.svg?maxAge=43200
